...
const pageConfig = require("../Config/Page/" + productConfig.productId + "/npro.json");
const serviceLogic = require("../Config/Page/" + productConfig.productId + "/npro/serviceLogic.js").default;
const dataFlow = require("../Config/Page/" + productConfig.productId + "/npro/dataFlow.js").default;
