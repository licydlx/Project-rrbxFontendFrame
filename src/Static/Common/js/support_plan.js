import support_plan_tab from '../../../Component/Common/support_plan_tab.js';
// 保障计划 TAB 切换事件
// ydlx
// 2018-1-31
...
const tabLogic = {
	...
	'changeContent': function(a, b) {
		$("#sp-content").empty().append(support_plan_tab(a.insurancePlan[b]));
	},
...
const support_plan = function(PZ){
	var num = PZ.insurancePlan.length;
	// 保障计划 NAV
