...
const e_npro_footer = function() {
	$("#container").on("click", "#buy-now", (event) => {
		...
		// 线上环境
		window.location.href = `${window.location.origin}/mobile/nproduct/productInsure.html?productId=${productConfig.productId}
		&access_token=${GV.accessToken}&exterChannel=${GV.exterChannel}
