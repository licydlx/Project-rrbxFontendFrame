...
const e_npro_footer = function(pars) {
	...
	$("#container").on("click", "#goBuy", () => {
		...
		//先上环境
		window.location.href = `${window.location.origin}/mobile/nproduct/productInsure.html?productId=
		${productConfig.productId}&access_token=${GV_TRIAL.accessToken}&exterChannel=${GV.exterChannel}
		&sp=${GV.expertId}&eid=${GV.eid}&channel=${GV.channel}&cal=1&sponsorGroup=${GV.sponsorGroup}
