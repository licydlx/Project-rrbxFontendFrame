...
import ajax_promise from '../../Static/js/depend/datas/load_ajax.js';
...
// 插件引入
import scrollSpy from '../../Static/js/depend/tools/scrollSpy.js';
...
const serviceLogic = require("./npro/serviceLogic.js").default;
const dataFlow = require("./npro/dataFlow.js").default;
