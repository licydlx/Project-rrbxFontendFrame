...
const serviceLogic = function(a) {
	...
	$("#container").on("blur", "input[data-type='certiNo']", function(event) {
		...
		if (relaState && Object.is("holder_certiNo", certiNoId)) {
			...
			if (!flag) {
				new dateModal(null, "stateIndform", "投保人年龄最小28天，最大65周岁").init().show();
	...
	// 逻辑:起保日期
	// 条件:...
	var effectDate = dateUnit.getEffectDate();
	$("#policyBeginDate").attr("value",effectDate);
	trialObj.policyBeginDate = effectDate;
